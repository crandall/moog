...
//  moog
//
//  Created by Mike Crandall on 1/21/24.
//
...
class RawOutputModel1: ObservableObject {
...
public struct RawOutputView1: View {
    @StateObject var rawOutputModel = RawOutputModel1()
